  ...
  return (
    <div className="relative group w-[400px]">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute top-[50%] left-1/2 transform -translate-x-1/2 w-[90%] h-[10%] opacity-0 -translate-y-4 transition-all duration-1000 ease-in-out group-hover:opacity-100 group-hover:translate-y-0 group-hover:h-[240px] bg-gradient-to-br from-[#a9b1bd] to-[#dbe4e3] rounded-bl-[20px] rounded-br-[20px] border border-gray-300 shadow-lg px-8 py-8 pt-16 pb-10 z-0">
